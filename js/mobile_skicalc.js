...
function onSave(){
    ...
    if (lengthTOT == "" || lengthW == "" || lengthH == "" || front == "" || middle == "" || rear == "" || radius == "") {
        ...
        alert_empty("Ski total lenght, Ski lenght rear, Front ski width, Middle ski width, Rear ski width and Radius are required fields!<br>Please and calculate these values before saving!","");
    }else {
...
function alert_autoclose(text,res){
	...
	window.console && console.log(text);
	$( "#alertauto" ).bind({
		popupafteropen: function() {setTimeout(
		function () {
